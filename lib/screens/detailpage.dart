...
//   if (user != null) {
//     setState(() {
//       _selectedUnit = user!.tempUnit; // ambil dari DB / SharedPreferences
//     });
//   }
// }
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: List.generate(count, (i) {
                int index = currentHour + i;
                bool isNow = i == 0;
                final convertedTemp = TempConverter.convert(value: hourly.temperature[index], from: "c", to: _selectedUnit).round();
                return _buildHourlyItem(
      ...
      child: Column(
        ...
        children: [
          ...
          ListView.separated(
            ...
            separatorBuilder: (_, __) => const Divider(color: Colors.white12),
            itemBuilder: (context, index) {
              final convertedMax = TempConverter.convert(value: daily.tempMax[index], from: "c", to: _selectedUnit).round();
              final convertedMin = TempConverter.convert(value: daily.tempMin[index], from: "c", to: _selectedUnit).round();
              return _buildDailyItem(
      ...
      child: GridView.count(
        ...
        children: [
          ...
          _buildConditionCard(
            ...
            unit: "",
            subtitle: aqi < 50 ? "Good" : "Moderate",
            visualContent: Icon(Icons.blur_on, color: Colors.white38, size: iconSize),
          ),
          _buildConditionCard(
            title: "Pressure",
            value: current.pressure.round().toString(),
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(
                    sunriseText,
                    style: const TextStyle(color: kTextWhite, fontSize: 20, fontWeight: FontWeight.w600),
                  ),
                ],
              ),
              Expanded(
